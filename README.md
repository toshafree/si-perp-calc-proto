...
Все заменяемые бизнес-константы собраны в [`src/config/dealConfig.ts`](src/config/dealConfig.ts): дата экспирации, ГО на пару, комиссия, начальный капитал, ставка займа и пресеты фандинга.
...
- Фандинг: ставка за рабочий день × рабочие дни; положительный для Short, отрицательный для Long.
